<%-- 
    Document   : dashboard
    Created on : 8 Dec, 2018, 8:27:13 AM
    Author     : Sajid
--%>
...
<%
            ...
            String loc = (String) session.getAttribute("fbloc");
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT  F_ID,SUPPLIER,BRANCH,sum(QTY) as x,EMP,CALENDER FROM FDA.RECEIVE  where STATUS='pending' and FB_LOC='"+loc+"'  group by F_ID,SUPPLIER,BRANCH,EMP,CALENDER");
...
<%
                    ...
                    PreparedStatement ps1 = con1.prepareStatement("SELECT  F_ID,SUPPLIER,BRANCH,sum(QTY) as x,EMP,CALENDER FROM FDA.RECEIVE  where STATUS='ACTIVE' and FB_LOC='"+loc+"' group by F_ID,SUPPLIER,BRANCH,EMP,CALENDER");
...
<%
                    ...
                    PreparedStatement ps2 = con2.prepareStatement("SELECT  distinct D.F_ID,D.CHARITY_NAME,D.SIGNEE,D.FB_LOC,D.TIME,D.CALENDER,U.TEL FROM FDA.DELIVERED D  INNER JOIN FDA.USERS U ON D.SIGNEE=U.USERNAME where D.STATUS='pending' and FB_LOC='"+loc+"'");
