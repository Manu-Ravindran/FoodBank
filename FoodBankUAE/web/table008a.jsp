<%-- 
    Document   : table008a
    Created on : 28 Nov, 2018, 11:36:53 PM
    Author     : Sajid
--%>
...
%>
	...
	ResultSet rs = st.executeQuery("SELECT  CATEGORY,PRODUCT,sum(QTY) FROM FDA.RECEIVE where calender>='"+a+"' and calender<='"+b+"'  group by category,product order by sum(QTY) desc");    
                while(rs.next())
                      {
                          out.println("<tr>");
                          out.println("<td>");
