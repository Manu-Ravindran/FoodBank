<%-- 
    Document   : table002a
    Created on : 28 Nov, 2018, 5:01:31 PM
    Author     : Sajid
--%>
...
%>
	...
	ResultSet rs = st.executeQuery("SELECT PRODUCT,sum(QTY) FROM FDA.RECEIVE where SUPPLIER='"+c+"' and CALENDER between  '"+a+"' and '"+b+"' group by product order by sum(qty) desc");    
                while(rs.next())
                      {
                          out.println("<tr>");
                          out.println("<td>");
