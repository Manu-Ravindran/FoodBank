<%-- 
    Document   : deliverModify
    Created on : 28 Nov, 2018, 6:01:16 AM
    Author     : Sajid
--%>
...
tr:nth-child(even){background-color: #f2f2f2}
    ...
    <body>
        ...
        <div class="container">
            <form name="vinform" action="mdfy3">
	...
	ResultSet rs = st.executeQuery();  
        ...
        while(rs.next())
        {
            ...
            out.println("</td>");
            out.println("<td>");
            out.println("<input type='radio' name='idVal2'  value='"+rs.getInt("id")+","+rs.getString("product")+","+rs.getInt("qty")+"'>");
