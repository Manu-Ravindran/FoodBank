<%-- 
    Document   : receive1b
    Created on : 6 Dec, 2018, 1:46:40 PM
    Author     : Sajid
--%>
...
<script type="text/javascript">
    ...
    <body>
        <script type="text/javascript">
            function TDate() {
var UserDate = document.getElementById("mfd").value;
var ToDate = document.getElementById("exp").value;
  
if (new Date(UserDate).getTime() >= new Date(ToDate).getTime()) {
    alert("The Expiry Date must be Bigger than Manufacturing  date");
    return false;
}
return true;}
        </script>
  ...
  <div class="container">
    ...
    <input type="date" id="exp" name='exp' onchange="TDate()" required/>
    <font style="color: red"><span id="dt"></span></font>
    
    <label for="qty"><b>ENTER QUANTITY</b></label>
    <input type="text" id='qt' name='qt'/>
    
    <label for="qty"><b>ENTER WEIGHT PER QTY</b></label>
    <input type="text" id='wt' name='wt'/>
