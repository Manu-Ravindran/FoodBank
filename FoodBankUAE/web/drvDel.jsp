<%-- 
    Document   : drvDel
    Created on : 23 Nov, 2018, 7:08:16 PM
    Author     : Sajid
--%>
...
tr:nth-child(even){background-color: #f2f2f2}
    ...
    <body>
        ...
        <div class="container">
            <form action="mdfy2" enctype="multipart/form-data">
	...
	ResultSet rs = st.executeQuery();  
        ...
        while(rs.next())
        {
            ...
            out.println("</td>");
            out.println("<td>");
            out.println("<input type='checkbox' name='idValue' value='"+rs.getInt("id")+","+rs.getString("product")+","+rs.getDouble("qty")+"'>");
