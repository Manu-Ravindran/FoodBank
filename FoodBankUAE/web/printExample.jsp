<%-- 
    Document   : printExample
    Created on : 30 Nov, 2018, 6:54:12 PM
    Author     : Sajid
--%>
...
tr:nth-child(even){background-color: #f2f2f2}
  ...
  <div class="container">
	...
	PreparedStatement st = connection.prepareStatement("SELECT * from FDA.receive where f_id=?  ");
	st.setInt(1, rid);
	ResultSet rs = st.executeQuery();  
        ...
        %>
          ...
          <input type="submit" value="delete">
              ...
              <button type="button" onclick="window.location.replace('DriverBt3.jsp')"> ADD MORE</button>&nbsp;&nbsp;
