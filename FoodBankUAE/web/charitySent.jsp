<%-- 
    Document   : charitySent
    Created on : 15 Dec, 2018, 8:57:46 PM
    Author     : Sajid
--%>
...
<body>
    <form action="sentDel3.jsp" enctype="multipart/form-data">
<div style="overflow-x:auto;">
  <table>
    ...
    <%
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT * FROM FDA.send where sender='"+usr+"' ");
