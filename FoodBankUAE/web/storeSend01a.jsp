<%-- 
    Document   : storeSend01a
    Created on : 15 Dec, 2018, 8:34:50 PM
    Author     : Sajid
--%>
...
<html>
    ...
    <body>
        <%
            ...
            String sender=(String)session.getAttribute("sname");
            ...
            RequestDispatcher q=request.getRequestDispatcher("storeMail.jsp");
