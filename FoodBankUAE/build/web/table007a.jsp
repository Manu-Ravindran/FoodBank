<%-- 
    Document   : table007a
    Created on : 28 Nov, 2018, 11:22:57 PM
    Author     : Sajid
--%>
...
%>
	...
	ResultSet rs = st.executeQuery("SELECT year(CALENDER) as y,sum(QTY) as q FROM FDA.delivered where year(CALENDER)>="+a+" and year(CALENDER)<="+b+" group by year(CALENDER)");    
                while(rs.next())
                      {
                          out.println("<tr>");
                          out.println("<td>");
