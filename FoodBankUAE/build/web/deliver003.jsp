<%-- 
    Document   : deliver003
    Created on : 27 Nov, 2018, 8:45:31 PM
    Author     : Sajid
--%>
...
<form action="db2">
    <%
            String fbloc = (String) session.getAttribute("fbloc2");
            Integer rid = (Integer) session.getAttribute("no1");
            String id=Integer.toString(rid);
            String bname = (String) session.getAttribute("cname");
            out.println("<input type='hidden' id='branch' name='branch' value='"+bname+"'>");
            out.println("<input type='hidden' id='userid' name='userid' value='"+id+"'>");
            
            out.println("<input type='hidden' id='fbloc' name='fbloc' value='"+fbloc+"'>");
        %>
  <div class="container">
	...
	PreparedStatement st = connection.prepareStatement("SELECT distinct category FROM FDA.inventory  ");
