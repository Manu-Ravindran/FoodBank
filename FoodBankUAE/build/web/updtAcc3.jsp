<%-- 
    Document   : updtAcc3
    Created on : 8 Dec, 2018, 2:45:54 PM
    Author     : Sajid
--%>
...
<script type="text/javascript">
    ...
    <body >
        ...
        <div class="container">
            <form name="vinform" action="updtDispatcher001.jsp">
   ...
   <input type="submit" value="CHANGE"/></br></br>
          ...
          <button type="button" onclick="window.location.replace('charity.jsp')">BACK</button>&nbsp;&nbsp;
