<%-- 
    Document   : DriverBt3
    Created on : 20 Nov, 2018, 10:31:22 PM
    Author     : Sajid
--%>
...
<form action="db1">
    <%
            ...
            String fbloc = (String) session.getAttribute("fbloc1");
            
            Integer rid = (Integer) session.getAttribute("idnm");
            String id=Integer.toString(rid);
            String bname = (String) session.getAttribute("branch");
            ...
            out.println("<input type='hidden' id='b' name='b' value='"+bloc+"'>");
